...
$(document).ready(function() {
    ...
    function createRadios() {
        ...
        for (var i = 0; i < questions[questionCounter].choices.length; i++) {
                // responseOptions.append('<button>' + [i] + )
            ...
            // responseOptions.append('<div><input type="radio" name="optionRadios" id="optionsRadios2 value="' + [i] + '" class="twd-opt"><label for="option' + [i] + '">' + questions[questionCounter].choices[i] + '</label></div><br/>'
